...
import { specificUserToken } from "../../redux/Slicers/ToCart.js";
import { url } from "../API/api.js";
// import { loginToBuy } from "../../redux/Slicers/buyAfterLogin.js";

function LoginPage({ setLogin }) {

    const dispatch = useDispatch();
    const navigate = useNavigate();
    const checker = useSelector((store)=>store.checkingLog.value);
        ...
        try {
            ...
            /* LOGIN */
                ...
                if (success) {
                    ...
                    dispatch(specificUserToken(token));
    ...
    useEffect(() => {
        if (window.google) {
            google.accounts.id.initialize({
                client_id: "1043551492666-7mohi5q8b5pkf3mfr6o0fgg7iaphr34f.apps.googleusercontent.com",
    ...
    const responseOnCallback = async (response) => {
        ...
        if (result.success) {
            ...
            dispatch(specificUserToken(result.token));
